...
classifier.save('modelImageGrande.h5')



from keras.models import load_model
model = load_model('modelImageGrande.h5')

from keras.preprocessing import image
import numpy as np
test_image = image.load_img('dataset/single_prediction/cat_or_dog_1.jpg', target_size=(x_size, y_size))
...
test_image = image.load_img('dataset/single_prediction/cat_or_dog_2.jpg', target_size=(x_size, y_size))
test_image = image.img_to_array(test_image)
test_image = np.expand_dims(test_image, axis=0)
classes = model.predict_classes(test_image, batch_size=10)
if classes[0][0] == 1:
